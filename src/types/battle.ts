...
export type Unit = {
  id:string; name:string; owner:0|1; image:string;
  quality:number; defense:number; speed:number;
  wounds:number; maxWounds:number; weapons:Weapon[];
  position?:{ q:number; r:number }; traits?: string[]
}
